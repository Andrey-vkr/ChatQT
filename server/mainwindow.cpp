  ...
  activeUserRow_(0), activeMessageRow_(0)
{
  ...
  server_ = new ServerQt(port, database_);
...
void MainWindow::on_pushButton_RemoveUser_clicked()
{
  ...
  QString message = "Do you want to delete a user: " + loginToDelete + " ?";
...
void MainWindow::on_pushButton_RemoveMessage_clicked()
{
  ...
  auto label = new QLabel(&dialog);
  QString message = "Do you want to delete the message: '" + messageText + "' ?";
  label->setText(message);
  label->setAlignment(Qt::AlignHCenter);
